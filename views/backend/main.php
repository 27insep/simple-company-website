...
<script src="<?php echo WEB_PATH;?>/assets/js/JavaScript-Load-Image-master/js/load-image.all.min.js"></script>
<script src="<?php echo WEB_PATH;?>/assets/js/JavaScript-Canvas-to-Blob-master/js/canvas-to-blob.min.js"></script>
