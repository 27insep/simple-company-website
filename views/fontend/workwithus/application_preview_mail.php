...
<div id="main_all">
	 <h2 class="topic">รายละเอียดผู้สมัคร</h2>
					  ...
					  <div align="right">
						<table border="0" cellspacing="10" width="250">
							...
							<td style="border:1px #999 solid;" align="center" bgcolor="#F7F7F7" width="230" height="250">
								<p>รูปประจำตัว</p>
								<div><img src="http://www.hitera.com/<?=$data['pic_path']?>" width="250" height="300" /></div>
							</td>
							</tr></tbody>
						</table>
					</div>
					  ...
					  <td bgcolor="#F6F6F6" width="400">
						<?php
							...
							foreach($province_list as $val){
								//echo $val["province_id"]."<br />";
								
								if($data['born_province'] == $val["province_id"]){
									echo $val["province_name"];
								}
							}
						?>	
					  </td>
	...
	<?php	}	?>		
					...
					<tr>
					  ...
					  <?php
							...
							foreach($province_list as $val){
								...
								if($data['cur_province'] == $val["province_id"]){
									echo $val["province_name"];
								}
							}
						?>
					  ...
					  <td bgcolor="#F6F6F6" width="220">
						<?php
							...
							foreach($province_list as $val){
								...
								if($data['home_province'] == $val["province_id"]){
									echo $val["province_name"];
								}
							}
						?>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%">
					...
					<?	if(isset($work_data2)){	?>
						  ...
						  <tr>
							<td align="right" bgcolor="#EEEDED" width="200"><strong>ชื่อบริษัท :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['company_name']?>&nbsp;</td>
							<td align="right" bgcolor="#EEEDED"><strong>ที่ตั้งบริษัท :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['comp_addr']?>&nbsp;</td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>โทรศัพท์ :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['comp_tel']?>&nbsp;</td>
							<td align="right" bgcolor="#EEEDED">&nbsp;</td>
							<td align="left" bgcolor="#F6F6F6">&nbsp;</td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>เข้าทำงานเมื่อ :</strong>&nbsp;</td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['date_in']?></td>
							<td align="right" bgcolor="#EEEDED"><strong>ตำแหน่งงานเริ่มต้น :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['posi_in']?></td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong> ลาออกเมื่อ :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['date_out']?></td>
							<td align="right" bgcolor="#EEEDED"><strong>ตำแหน่งงานล่าสุด :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['posi_out']?></td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>หน้าที่/ความรับผิดชอบครั้งสุดท้าย : </strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['responsibility']?></td>
							<td align="right" bgcolor="#EEEDED">&nbsp;</td>
							<td align="left" bgcolor="#F6F6F6">&nbsp;</td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>เงินเดือนเริ่มต้น :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['salary_in']?></td>
							<td align="right" bgcolor="#EEEDED"><strong> เงินเดือนครั้งล่าสุด :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['salary_out']?></td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>ชื่อผู้บังคับบัญชาคนล่าสุด :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data2['manager']?></td>
							<td align="right" bgcolor="#EEEDED">&nbsp;</td>
							<td align="left" bgcolor="#F6F6F6">&nbsp;</td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>สาเหตุที่ออก :</strong></td>
							<td colspan="3" align="left" bgcolor="#F6F6F6"><?=$work_data2['remark']?></td>
						  </tr>
					<?	}	?>
					<?	if(isset($work_data3)){	?>
						  <tr>
						  ...
						  <tr>
							<td align="right" bgcolor="#EEEDED" width="200"><strong>ชื่อบริษัท :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['company_name']?>&nbsp;</td>
							<td align="right" bgcolor="#EEEDED"><strong>ที่ตั้งบริษัท :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['comp_addr']?>&nbsp;</td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>โทรศัพท์ :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['comp_tel']?>&nbsp;</td>
							<td align="right" bgcolor="#EEEDED">&nbsp;</td>
							<td align="left" bgcolor="#F6F6F6">&nbsp;</td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>เข้าทำงานเมื่อ :</strong>&nbsp;</td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['date_in']?></td>
							<td align="right" bgcolor="#EEEDED"><strong>ตำแหน่งงานเริ่มต้น :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['posi_in']?></td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong> ลาออกเมื่อ :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['date_out']?></td>
							<td align="right" bgcolor="#EEEDED"><strong>ตำแหน่งงานล่าสุด :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['posi_out']?></td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>หน้าที่/ความรับผิดชอบครั้งสุดท้าย : </strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['responsibility']?></td>
							<td align="right" bgcolor="#EEEDED">&nbsp;</td>
							<td align="left" bgcolor="#F6F6F6">&nbsp;</td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>เงินเดือนเริ่มต้น :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['salary_in']?></td>
							<td align="right" bgcolor="#EEEDED"><strong> เงินเดือนครั้งล่าสุด :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['salary_out']?></td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>ชื่อผู้บังคับบัญชาคนล่าสุด :</strong></td>
							<td align="left" bgcolor="#F6F6F6"><?=$work_data3['manager']?></td>
							<td align="right" bgcolor="#EEEDED">&nbsp;</td>
							<td align="left" bgcolor="#F6F6F6">&nbsp;</td>
						  </tr>
						  <tr>
							<td align="right" bgcolor="#EEEDED"><strong>สาเหตุที่ออก :</strong></td>
							<td colspan="3" align="left" bgcolor="#F6F6F6"><?=$work_data3['remark']?></td>
						  </tr>
					<?	}	?>
						</tbody></table></td>
				</tr>
